                    ...
                    <form action="{{ route('dashboard.users.index') }}" method="get">
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                <button class="orm-control btn btn-primary"><i class="fa fa-search"></i>@lang('site.search')</button>
                                ...
                                <tbody>
                                    @foreach ($users as $index=>$user)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $user->email }}</td>
                                            <td><img src='{{ asset("uploads/user_images/" . $user->img) }}' class="img-thumbnail" width='100px' ></td>
                                            <td>
                                                {{-- @if (auth()->user()->hasPermission('update_users')) --}}

                                                    <a href="{{ route('dashboard.users.edit', $user->id) }}" class="btn btn-info btn-sm"><i class="fa fa-edit">@lang('site.edit')</i></a>
                                                {{-- @else --}}
                                                ...
                                                {{-- @if (auth()->user()->hasPermission('delete_users')) --}}
                                                    <form action="{{ route('dashboard.users.destroy', $user->id) }}" method="post" style="display: inline-block">
                                                        ...
                                                        <button class="btn btn-danger btn-sm delete"><i class="fa fa-trash">@lang('site.delete')</i></button>
                                                    </form>
                                                {{-- @else
